...
urlpatterns = [
    ...
    path('toggle_diagnosis_status/<uuid:diagnosis_id>/', toggle_diagnosis_status, name='toggle_diagnosis_status'),
    ...
    path("search/", search_doctors_view, name="search_doctors"),
